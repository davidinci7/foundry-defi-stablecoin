...
contract DSCEngine is ReentrancyGuard {
     ...
     */
    function depositCollateral(address tokenCollateralAddress, uint256 amountCollateral) moreThanZero(amountCollateral) isAllowedToken(tokenCollateralAddress) nonReentrant external{
